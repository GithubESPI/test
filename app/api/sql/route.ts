  ...
  try {
    ...
    const queries: Record<keyof QueryResults, string> = {
      ...
      APPRENANT: `
        ...
        WHERE g.CODE_GROUPE = ${group} AND (i.DATE_FIN_INSCRIPTION IS NULL OR i.DATE_FIN_INSCRIPTION >= GETDATE()) GROUP BY a.CODE_APPRENANT, a.NOM_APPRENANT, a.PRENOM_APPRENANT, a.DATE_NAISSANCE, g.CODE_GROUPE, c.CODE_CALENDRIER, s.CODE_SESSION ORDER BY a.NOM_APPRENANT
      `,
