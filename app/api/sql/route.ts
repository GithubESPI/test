...
export async function POST(request: Request) {
  try {
    ...
    const queries: Record<keyof QueryResults, string> = {
      GROUPE: `
        SELECT DISTINCT g.NOM_GROUPE, g.ETENDU_GROUPE, g.NUMERO_ANNEE, f.NOM_FORMATION
        FROM FORMATION f
        ...
        GROUP BY g.NOM_GROUPE, g.ETENDU_GROUPE, g.NUMERO_ANNEE, f.NOM_FORMATION, s.CODE_SESSION
      `,
